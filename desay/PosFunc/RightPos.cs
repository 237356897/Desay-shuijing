...
namespace Vision_Assistant
{
    static class RightPos
    {
        ...
        public static string RightCali;
        public static string[] RightCaliArrary;
        ...
        public static PaletteType ProcessImage(VisionImage image, Point pointOffset)
        {
            ...
            RectangleContour vaRect = new RectangleContour(589, 514, 1197, 863);
            roi.Add(vaRect);
            ...
            if (pmResults.Count == 1)
            {
                ...
                double refSysOriginX = 1106;
                double refSysOriginY = 990.5;
                ...
                PointContour vaCenter = new PointContour(850, 857.5);
                RotatedRectangleContour vaRotatedRect = new RotatedRectangleContour(vaCenter, 68, 575, 0);
                ...
                vaOptions.MinimumThreshold = Position.Instance.EdgeThreshold_Right;
                ...
                Roi roi3 = new Roi();
                // Creates a new RotatedRectangleContour using the given values.
                PointContour vaCenter2 = new PointContour(1616, 858);
                RotatedRectangleContour vaRotatedRect2 = new RotatedRectangleContour(vaCenter2, 46, 580, 0);
                ...
                vaOptions2.MinimumThreshold = Position.Instance.EdgeThreshold_Right;
                ...
                Roi roi4 = new Roi();
                // Creates a new RotatedRectangleContour using the given values.
                PointContour vaCenter3 = new PointContour(1237, 1841);
                RotatedRectangleContour vaRotatedRect3 = new RotatedRectangleContour(vaCenter3, 490, 60, 0);
                ...
                vaOptions3.MinimumThreshold = Position.Instance.EdgeThreshold_Right;
                ...
                vaStraightEdgeOptions3.StepSize = 35;
                ...
                Roi roi5 = new Roi();
                // Creates a new RotatedRectangleContour using the given values.
                PointContour vaCenter4 = new PointContour(1266, 38);
                RotatedRectangleContour vaRotatedRect4 = new RotatedRectangleContour(vaCenter4, 468, 66, 0);
                ...
                vaOptions4.MinimumThreshold = Position.Instance.EdgeThreshold_Right;
                ...
                //计算每个角的偏差
                string str1 = Math.Round((-caliperIntersection.X - pointOffset.X + Position.Instance.SpecRightPos_X[0]) / 96, 3).ToString() + ";" + Math.Round((-caliperIntersection.Y - pointOffset.Y + Position.Instance.SpecRightPos_Y[0]) / 96, 3).ToString() + ";";
                string str2 = Math.Round((-caliperIntersection2.X - pointOffset.X + Position.Instance.SpecRightPos_X[1]) / 96, 3).ToString() + ";" + Math.Round((-caliperIntersection2.Y - pointOffset.Y + Position.Instance.SpecRightPos_Y[1]) / 96, 3).ToString() + ";";
                string str3 = Math.Round((-caliperIntersection3.X - pointOffset.X + Position.Instance.SpecRightPos_X[2]) / 96, 3).ToString() + ";" + Math.Round((-caliperIntersection3.Y - pointOffset.Y + Position.Instance.SpecRightPos_Y[2]) / 96, 3).ToString() + ";";
                string str4 = Math.Round((-caliperIntersection4.X - pointOffset.X + Position.Instance.SpecRightPos_X[3]) / 96, 3).ToString() + ";" + Math.Round((-caliperIntersection4.Y - pointOffset.Y + Position.Instance.SpecRightPos_Y[3]) / 96, 3).ToString();
                RightCali = str1 + str2 + str3 + str4;
                RightCaliArrary = new string[] { str1, str2, str3, str4 };
            }
            else
            {
                RightCali = "0;0;0;0;0;0;0;0";
                RightCaliArrary = new string[] { "0;0", "0;0", "0;0", "0;0" };
            }
        ...
        public static PaletteType RectRightPos(VisionImage image, Point pointOffset)
        {
            // Initialize the IVA_Data structure to pass results and coordinate systems.
            IVA_Data ivaData = new IVA_Data(12, 1);
            ...
            if (pmResults.Count == 1)
            {
                ...
                Roi roi2 = new Roi();
                // Creates a new RotatedRectangleContour using the given values.
                PointContour vaCenter = new PointContour(846.5, 853.5);
                RotatedRectangleContour vaRotatedRect = new RotatedRectangleContour(vaCenter, 67, 829, -359.98);
                roi2.Add(vaRotatedRect);
                // Reposition the region of interest based on the coordinate system.
                int coordSystemIndex = 0;
                Algorithms.TransformRoi(roi2, new CoordinateTransform(ivaData.baseCoordinateSystems[coordSystemIndex], ivaData.MeasurementSystems[coordSystemIndex]));
                ...
                Roi roi3 = new Roi();
                // Creates a new RotatedRectangleContour using the given values.
                PointContour vaCenter2 = new PointContour(1234.5, 112);
                RotatedRectangleContour vaRotatedRect2 = new RotatedRectangleContour(vaCenter2, 537, 102, -0.072);
                roi3.Add(vaRotatedRect2);
                // Reposition the region of interest based on the coordinate system.
                int coordSystemIndex2 = 0;
                Algorithms.TransformRoi(roi3, new CoordinateTransform(ivaData.baseCoordinateSystems[coordSystemIndex2], ivaData.MeasurementSystems[coordSystemIndex2]));
                ...
                Roi roi4 = new Roi();
                // Creates a new RotatedRectangleContour using the given values.
                PointContour vaCenter3 = new PointContour(1583, 866.5);
                RotatedRectangleContour vaRotatedRect3 = new RotatedRectangleContour(vaCenter3, 76, 837, -359.981);
                roi4.Add(vaRotatedRect3);
                // Reposition the region of interest based on the coordinate system.
                int coordSystemIndex3 = 0;
                Algorithms.TransformRoi(roi4, new CoordinateTransform(ivaData.baseCoordinateSystems[coordSystemIndex3], ivaData.MeasurementSystems[coordSystemIndex3]));
                ...
                Roi roi5 = new Roi();
                // Creates a new RotatedRectangleContour using the given values.
                PointContour vaCenter4 = new PointContour(1224.5, 1553);
                RotatedRectangleContour vaRotatedRect4 = new RotatedRectangleContour(vaCenter4, 521, 62, -359.981);
                roi5.Add(vaRotatedRect4);
                // Reposition the region of interest based on the coordinate system.
                int coordSystemIndex4 = 0;
                Algorithms.TransformRoi(roi5, new CoordinateTransform(ivaData.baseCoordinateSystems[coordSystemIndex4], ivaData.MeasurementSystems[coordSystemIndex4]));
                ...
                // Computes the vaIntersection point between two lines.
                Collection<PointContour> vaIntersection2 = IVA_GetIntersection(image, ivaData, 9, 7, 0, 7, 2, 6, 0, 6, 2);
                caliperIntersection2 = vaIntersection2[0];
                ...
                // Computes the vaIntersection point between two lines.
                Collection<PointContour> vaIntersection3 = IVA_GetIntersection(image, ivaData, 10, 7, 0, 7, 2, 4, 0, 4, 2);
                caliperIntersection3 = vaIntersection3[0];
